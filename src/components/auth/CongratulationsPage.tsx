...
export default function CongratulationsPage({ userName }: CongratulationsPageProps) {
  return (
      ...
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">
            You're now part of our culinary community. Get ready to explore a world of 
            delicious recipes and cooking inspiration!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <div className="p-4 bg-emerald-50 rounded-xl">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">Personalized Recipes</h3>
            <p className="text-sm text-gray-600">Access your custom recipe collection</p>
          </div>
          <div className="p-4 bg-emerald-50 rounded-xl">
            <ChefHat className="w-6 h-6 text-emerald-500 mb-2 mx-auto" />
            <h3 className="font-semibold text-gray-900 mb-1">Weekly Meal Plans</h3>
            <p className="text-sm text-gray-600">Get tailored meal suggestions</p>
          </div>
        </div>
